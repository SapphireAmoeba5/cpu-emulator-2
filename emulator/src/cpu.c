...
static instruction_f instructions[256] = 
{
    ...
    /* 0x10 */ jmp,  jnz,   invl, invl, invl, invl, invl, invl, invl, invl, invl, invl, invl, invl, invl, invl,
    /* 0x20 */ jz, invl,  invl, invl, invl, sub_reg, sub_imm, sub_mem, invl, invl, invl, invl, invl, invl, invl, invl,
